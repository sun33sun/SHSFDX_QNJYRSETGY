...
namespace SHSFDX_QNJYRSETGY
{
    public class Main : MonoBehaviour
    {
        IEnumerator Start()
        {
            ...
            yield return UIKit.PreLoadPanelAsync<CognitionPanel>(UILevel.Common,
                prefabName: Settings.UI + CognitionPanel.Name);
            UIKit.HidePanel<CognitionPanel>();
            yield return UIKit.PreLoadPanelAsync<AnswerPanel>(UILevel.Common,
                prefabName: Settings.UI + AnswerPanel.Name);
            UIKit.HidePanel<AnswerPanel>();
            yield return UIKit.PreLoadPanelAsync<ReportPanel>(UILevel.Common,
                prefabName: Settings.UI + ReportPanel.Name);
